...
sealed interface PaymentInfo {
    ...
    val walletType: WalletType? get() = null
}

enum class PaymentMethodType { CARD, WALLET, ACH }
enum class WalletType { APPLE_PAY, GOOGLE_PAY, LINK, NAVER_PAY }
...
data class CardInfo(
    ...
    override val methodType: PaymentMethodType = PaymentMethodType.CARD
}
...
data class WalletInfo(
    ...
    override val methodType: PaymentMethodType = PaymentMethodType.WALLET
    override val walletType: WalletType get() = wallet
}
...
data class AchInfo(
    ...
    override val methodType: PaymentMethodType = PaymentMethodType.ACH
}
